...
/**
 * Controlador del panel de administración. Lee el fichero
 * HistorialTresEnRaya.txt y calcula estadísticas. Formato de cada línea:
 * nPartida;jugador1;jugador2;ganador;fecha Usa únicamente arrays básicos, sin
 * colecciones.
 */
public class ControlAdmin {

	private static int MAX = 500;
	private static String RUTA = ".\\Data\\HistorialTresEnRaya.txt";
	...
	public String[] getJugador1s() {
		return jugador1s;
	}

	public String[] getJugador2s() {
		return jugador2s;
	}
